...
from hpbandster.optimizers.config_generators.rondomforestei import RandomForestEI as CG_RandomForestEI

class RandomForestEI(Master):
	def __init__(self, configspace = None,
					...
					**kwargs ):
		"""
                GP EI MCMC HB performs robust and efficient hyperparameter optimization
                at scale by combining the speed of Hyperband searches with the
                guidance and guarantees of convergence of Gaussian Process Expected Improvement
				MCMC. Instead of sampling new configurations at random,
		...
		cg = CG_RandomForestEI( configspace = configspace,
